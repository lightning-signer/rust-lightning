...
mod tests {
	...
	use ::{hex, chain};
	use prelude::*;
	use ln::chan_utils::{get_htlc_redeemscript, CommitmentTransaction, TxCreationKeys, ChannelTransactionParameters, CounterpartyChannelTransactionParameters, HTLCOutputInCommitment};
